...
- **The diet itself is already landed** (`e50cc2b`: 81,012 → 64,079 B, −20.9%, nothing deleted — the two offender refutation entries compressed to the shape the other 23 already had, and the cross-model procedure relocated to a pointer). This change makes it **stick**.
