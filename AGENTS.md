...
| `harden-churn-shell-readiness` | proposed (0/12) | churn-flake fix: computed-marker readiness gate + `.common`-modes dump timer; `3.2` now delegates to the validator (retrofit) | `research/03-analysis/confirm-close-shell-readiness.md` |
